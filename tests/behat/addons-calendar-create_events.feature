...
Feature: Test creation of calendar events in app
  ...
  Scenario: Create user event as student from monthly view
    ...
    And I set the field "Date" to "2035-09-11T09:00" in the app
    ...
    When I open the calendar for "9" "2035" in the app
    And I press "Tuesday, 11 September 2035" in the app
    Then I should find "User Event 01" in the app

    When I press "User Event 01" in the app
    Then I should find "Tuesday, 11 September" in the app
